...
export type Database = {
  _analytics: {
    Tables: {
      ...
      log_events_0666b8bd_f638_4b02_9e35_861702e4ee53: {
        Row: {
          body: Json | null
      ...
      log_events_0a7279e8_01d2_4cbe_837c_4c5988b1363b: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_10eb7efd_e649_4c37_94a1_0f1f2acea749: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_359b1b55_6081_4ded_9997_cc0a0d2ead69: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_379a5ab2_f34c_46a6_ab6b_95f3e610134e: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_4672b8b9_54c9_4039_8857_06e2c03b0c00: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_6ee1b1b4_e8ca_478f_bdcc_5be6a9b1bb65: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_d67fe2ca_2db1_49dc_bd3c_b73d7afe30bf: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_db14e1fb_52af_40b1_8a83_5ebb07474475: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
    ...
    Tables: {
      ...
      foundation_estimates: {
        Row: {
          ...
          groundwater_risk_multiplier: number | null
          id: string
          labor_cost: number | null
          material_cost: number | null
          site_analysis_id: string | null
          soil_complexity_multiplier: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "foundation_estimates_site_analysis_id_fkey"
      ...
      site_analyses: {
        Row: {
          ...
          foundation_cost: Json | null
          gemini_reasoning: string | null
          geological_data: Json | null
          id: string
          processing_time_ms: number | null
          roi_prediction: Json | null
          site_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "site_analyses_site_id_fkey"
            columns: ["site_id"]
      ...
      zoning_codes: {
        Row: {
          ...
          setback_front_meters: number | null
          setback_rear_meters: number | null
          setback_side_meters: number | null
